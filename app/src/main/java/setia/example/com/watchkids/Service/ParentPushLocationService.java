...
public class ParentPushLocationService extends Service
{
    ...
    private class LocationListener implements android.location.LocationListener
    {
        ...
        public void onLocationChanged(Location location)
        {
            ...
            WatchClient.get().UpdateLocationParent(PreferenceManager.getId(), String.valueOf(location.getLatitude()), String.valueOf(location.getLongitude())).enqueue(new Callback<Respond>() {
                @Override
